...
import { useMudarSenhaForm } from "../../hooks/Auth/useMudarSenhaForm";
...
export function MudarSenha() {
  ...
  async function onSubmit(data: any) {
    try {
      ...
      showMessage(mensagem, TypeMessage.error);
    }
  }
      ...
      <Controller
        ...
        render={({ field }) => (
          <InputField
            ...
            icon="lock"
            iconPosition="inside"
            rightIcon={mostrarSenhaAtual ? "eye" : "eye-off"}
            onRightIconPress={() => setMostrarSenhaAtual(!mostrarSenhaAtual)}
      ...
      <Controller
        ...
        render={({ field }) => (
          <InputField
            ...
            icon="lock"
            iconPosition="inside"
            rightIcon={mostrarNovaSenha ? "eye" : "eye-off"}
            onRightIconPress={() => setMostrarNovaSenha(!mostrarNovaSenha)}
      ...
      <Controller
        ...
        render={({ field }) => (
          <InputField
            ...
            icon="lock"
            iconPosition="inside"
            rightIcon={mostrarConfirmarSenha ? "eye" : "eye-off"}
            onRightIconPress={() =>
