...
export const CardBoletim = ({ item }: CardBoletimProps) => {
  ...
  const progress = Math.min(((item.boletimMedia || 0) / 10) * 100, 100);
    ...
    <View style={styles.card}>
      <View style={styles.header}>
        ...
        >
          ...
          >
            {statusLabels[item.boletimSituacao]}
          </Text>
        </View>
      </View>
      ...
      <View style={styles.infoContainer}>
        <View style={styles.infoItem}>
          ...
          <Text style={styles.infoValue}>
            {item.disciplina?.professor?.professorNome || "Não informado"}
          </Text>
        </View>
        ...
        <View style={styles.infoItem}>
          ...
          <Text style={styles.infoValue}>
            {item.disciplina.disciplinaSemestre}º
          </Text>
        </View>
        ...
        <View style={styles.infoItem}>
          ...
          <Text style={styles.infoValue}>
            {item.disciplina.disciplinaCargaHoraria}h
          </Text>
        </View>
      </View>
      ...
      <View style={styles.progressHeader}>
        <Text style={styles.progressText}>Desempenho</Text>
...
const NotaBox = ({ label, value, isMedia, styles }: any) => (
  <View style={[styles.notaBox, isMedia && styles.mediaBox]}>
    ...
    <Text style={[styles.notaLabel, isMedia && styles.mediaLabel]}>
      {label}
    </Text>
  </View>
);
